  ...
  return (
    <li className="dashboard-card flex flex-col gap-3 p-4 sm:flex-row sm:items-center sm:justify-between">
      <div className="min-w-0">
        <p className="truncate text-sm font-semibold text-ink">{income?.source || 'Other'}</p>
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 sm:justify-end">
        ...
        <div className="flex items-center gap-2">
          ...
          <button type="button" onClick={() => onDelete?.(income?.id)}
            className="rounded-lg bg-rose-400/10 px-2.5 py-1.5 text-xs font-semibold text-rose-600 ring-1 ring-rose-400/20 transition hover:bg-rose-400/20">
