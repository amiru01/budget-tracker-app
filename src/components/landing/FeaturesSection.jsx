...
import { LineChart, Wallet, Shield, Zap, ArrowUpRight, BarChart3 } from 'lucide-react'

const features = [
  {
    icon: <Wallet className="text-emerald-400" size={32} />,
    title: 'Smart Budgeting',
    description: 'Automatically categorize and track your spending in real-time with AI-driven insights.',
  ...
  },
  {
    ...
    description: 'Dive deep into your financial health with immersive 3D charts and dynamic reports.',
  ...
  },
  {
    ...
    description: 'Your data is encrypted and secure. We use industry-standard protocols to protect you.',
  ...
  },
  {
    ...
    description: 'Experience a smooth, lag-free dashboard built on modern edge infrastructure.',
  ...
  },
  {
    ...
    title: 'Goal Tracking',
    description: 'Set ambitious financial goals and watch your progress update instantly.',
  ...
  },
  {
    ...
    description: 'Export and share beautifully designed PDF reports of your financial journey.',
...
function FeatureCard({ feature, index }) {
  ...
  return (
    ...
    >
      ...
      <div className={`absolute inset-0 rounded-2xl bg-gradient-to-br ${feature.color} opacity-40 group-hover:opacity-60 transition-opacity duration-300`} />
      
      {/* Premium glass card */}
      <div className={`relative rounded-2xl border border-white/10 bg-white/[0.02] backdrop-blur-2xl p-8 shadow-xl ${feature.glow} group-hover:shadow-2xl group-hover:border-white/20 transition-all duration-300 overflow-hidden`}>
...
export default function FeaturesSection() {
  return (
    <section id="features" className="relative bg-slate-900 py-24 sm:py-32 overflow-hidden">
      {/* Background elements */}
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          >
            We've reimagined personal finance with premium 3D visuals and intelligent automation.
            No more boring spreadsheets—just clean, actionable insights.
          </motion.p>
        </div>
