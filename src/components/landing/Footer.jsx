      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="md:col-span-1">
            <Link to="/" className="flex items-center gap-3 group mb-6">
              ...
              <span className="text-lg font-semibold tracking-tight text-white">Smart Finance</span>
            </Link>
            <p className="text-sm text-slate-400 leading-relaxed">
              Master your wealth in 3D. The premium personal finance platform for the modern professional.
            </p>
              ...
              <ul className="space-y-3">
                {section.items.map((item) => (
                  <li key={item.name}>
                    ...
                    >
                      <span className="text-emerald-400/0 group-hover:text-emerald-400/100 transition-all">→</span>
                      {item.name}
                    </a>
                  </li>
                ))}
          ...
          <motion.div variants={itemVariants}>
            ...
            <div className="space-y-3">
              ...
              >
                <Mail size={16} className="text-emerald-400/60 group-hover:text-emerald-400 transition-colors" />
                <span className="text-xs text-slate-400 group-hover:text-slate-300 transition-colors">Support</span>
              </a>
              <a
                href="#"
              ...
              >
                <MessageCircle size={16} className="text-cyan-400/60 group-hover:text-cyan-400 transition-colors" />
                <span className="text-xs text-slate-400 group-hover:text-slate-300 transition-colors">Discord</span>
              </a>
            </div>
          </motion.div>
        </motion.div>
        ...
        >
          <motion.p variants={itemVariants} className="text-xs text-slate-500">
            &copy; {new Date().getFullYear()} Smart Finance. All rights reserved. • Built with ✨ for modern finance.
          </motion.p>

          {/* Status Badge */}
          <motion.div variants={itemVariants} className="flex items-center gap-2 text-xs text-slate-400">
