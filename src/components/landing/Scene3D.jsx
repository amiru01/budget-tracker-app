...
import { Environment, Float, PresentationControls, ContactShadows, Stars, RoundedBox } from '@react-three/drei'
...
function DashboardModel() {
  ...
  return (
    <group ref={group}>
      ...
      <RoundedBox position={[0, 0, 0]} args={[4, 2.4, 0.12]} radius={0.1} smoothness={12}>
      ...
      <RoundedBox position={[-1.2, 0.6, 0.15]} args={[1, 0.5, 0.04]} radius={0.02} smoothness={6}>
      ...
      <RoundedBox position={[0.4, 0.6, 0.15]} args={[0.9, 0.5, 0.04]} radius={0.02} smoothness={6}>
        <meshStandardMaterial 
          color="#3b82f6"
          metalness={0.3}
          roughness={0.4}
      ...
      <RoundedBox position={[0, -0.3, 0.15]} args={[2.2, 0.9, 0.04]} radius={0.02} smoothness={6}>
        <meshStandardMaterial 
          color="#1e293b"
          metalness={0.2}
          roughness={0.5}
  ...
  return (
    <div className="absolute inset-0 z-0 h-full w-full pointer-events-none md:pointer-events-auto">
      ...
      >
        ...
        <directionalLight position={[12, 15, 8]} intensity={1.2} color="#10b981" castShadow />
        <directionalLight position={[-10, -8, -5]} intensity={0.6} color="#3b82f6" />
