...
import { getAuthErrorMessage, signup, signInWithGoogle } from '../services/authService.js'
    ...
    <main className="flex min-h-screen items-center justify-center bg-[#F8F9FB] px-4 py-8">
      <section className="w-full max-w-md rounded-2xl bg-white p-6 shadow-lg ring-1 ring-slate-200 sm:p-8">
        ...
        <div className="mt-6 text-center">
          ...
          <h1 className="mt-1 text-2xl font-semibold tracking-tight text-slate-900">Create account</h1>
          <p className="mt-2 text-sm text-slate-600">Sign up with email/password or continue with Google.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="mt-6 space-y-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <Link to="/login" className="text-xs font-semibold text-cyan-600 hover:text-cyan-700">
              Log in
            </Link>
          </div>
        </form>
